...
export const pteranodon: DinosaurSpecies = {
  ...
  time_period: "86–84 million years ago (Coniacian to Santonian stages)",
  geographic_origin: "Western Interior Seaway, North America (Kansas, Texas, Wyoming)",
  ...
  bones: buildBones({
    ...
    antebrachium: {
      ...
      plain_language: "The radius and ulna formed a rigid yet lightweight strut that extended the wing's leading edge and controlled membrane tension during flight. These bones were elongated but not as dramatically as the fourth manual digit, creating a structural framework that resisted aerodynamic forces. The articulation between humerus and antebrachium allowed wing flexing for takeoff and landing.",
      research_note: "Fossil evidence shows the antebrachium bones were tightly bound together by ligaments, creating a semi-rigid structure optimized for gliding and soaring flight. Cross-sectional analysis reveals these bones were hollow with internal bracing, similar to aircraft wing spars. Comparison with modern pterosaur fossils and flight models suggests Pteranodon was primarily a glider that used thermal updrafts for sustained flight.",
    ...
    manus: {
      ...
      plain_language: "The fourth digit was extraordinarily elongated, extending up to 3 meters in large specimens, and formed the primary support for the pteroid and wing membrane. This single finger bore the majority of aerodynamic load during flight, making it the critical structural element of the wing. The three smaller digits were used for grasping and perching when the animal was grounded.",
      research_note: "The fourth digit's extreme elongation is unique to pterosaurs and represents a radical departure from the wing structure of birds and bats. Bone strength analysis indicates the fourth digit could withstand enormous bending and torsional stresses during powered flight and maneuvers. Fossil imprints of wing membranes show that the membrane was attached along the entire length of this digit and extended to the hind limbs.",
