...
export const velociraptor: DinosaurSpecies = {
  ...
  time_period: "Late Cretaceous (Campanian-Maastrichtian)",
  geographic_origin: "Central Asia (Mongolia, China)",
  notes:
